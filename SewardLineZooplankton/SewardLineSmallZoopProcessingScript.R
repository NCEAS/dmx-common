...
ggplot(data=SCZo1GAK, aes(y=sonicDepth, x=Site)) +
  geom_point() + theme_bw() + 
  scale_y_log10() + coord_cartesian(ylim = c(100, 4000))
  ylab("Bottom Depth (m)")
...
# Create Fall small zooplankton biomass
